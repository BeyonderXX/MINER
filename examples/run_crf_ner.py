...
def train(args, train_dataset, model, tokenizer, labels, pad_token_label_id, skip_label=-1):
    """ Train the model """
...
def arg_parse():
    ...
    parser.add_argument(
        "--output_dir",
        default="/root/RobustNER/out/bert_uncase/bsl_test/",
        type=str,
...
def main():
    ...
    logger.warning(
        "Process device: %s, 16-bits training: %s",
        args.device,
        args.fp16
    )
